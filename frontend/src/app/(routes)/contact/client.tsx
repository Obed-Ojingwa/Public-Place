...
// File: frontend/src/app/(routes)/contact/client.tsx
// Path: /home/obed/Documents/Public-Place/frontend/src/app/(routes)/contact/client.tsx
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <input
                      ...
                      type="email"
                      placeholder="Email Address"
                      className="px-4 py-3 rounded-lg border border-slate-200 focus:option-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      required
                    />
                  </div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:option-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-300 disabled:option-none disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    <Send className="w-4 h-4" />
